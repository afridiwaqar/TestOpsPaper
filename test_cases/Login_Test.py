...
def run(playwright):
    ...
    page.fill('input#name', 'John Doe5')  # Fill in the Name field
    page.fill('input#email', 'john.doe5@example.com')
    page.fill('input#username', 'johndoe5')
    page.fill('input#password', 'securepassword123')
    page.fill('input#password2', 'securepassword123')
